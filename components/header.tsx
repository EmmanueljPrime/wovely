                ...
                <div className="container mx-auto px-4 py-2 flex items-center justify-between">
                    <div className="flex space-x-4">
                        <div className="relative group">
                            ...
                            <div className="absolute hidden group-hover:block z-10 bg-white shadow-lg rounded-md p-2 min-w-40">
                                <Link
                                    href="/tailor?services=alterations"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    Alterations
                                </Link>
                                <Link
                                    href="/tailor?services=custom"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    Custom Clothing
                                </Link>
                                <Link
                                    href="/tailor?services=repairs"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    Repairs
                                </Link>
                                <Link
                                    href="/tailor?services=all"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    All Services
                                </Link>
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute hidden group-hover:block z-10 bg-white shadow-lg rounded-md p-2 min-w-40">
                                <Link
                                    href="/tailor?experience=1-3"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    1-3 years
                                </Link>
                                <Link
                                    href="/tailor?experience=3-5"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    3-5 years
                                </Link>
                                <Link
                                    href="/tailor?experience=5-10"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    5-10 years
                                </Link>
                                <Link
                                    href="/tailor?experience=10+"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    10+ years
                                </Link>
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute hidden group-hover:block z-10 bg-white shadow-lg rounded-md p-2 min-w-40">
                                <Link
                                    href="/tailor?type=individual"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    Individual
                                </Link>
                                <Link
                                    href="/tailor?type=professional"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    Professional
                                </Link>
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute hidden group-hover:block z-10 bg-white shadow-lg rounded-md p-2 min-w-40">
                                <Link
                                    href="/tailor?city=Paris"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    Paris
                                </Link>
                                <Link
                                    href="/tailor?city=Lyon"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    Lyon
                                </Link>
                                <Link
                                    href="/tailor?city=Marseille"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    Marseille
                                </Link>
                                <Link
                                    href="/tailor?city=Toulouse"
                                    className="block px-4 py-2 hover:bg-gray-100 rounded-md"
                                >
                                    Toulouse
                                </Link>
