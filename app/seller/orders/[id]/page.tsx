...
export default function SellerOrderDetail({ params }: { params: { id: string } }) {
  // Sample order data
  const order = {
    ...
    timeline: [
      { id: 1, status: "Order Confirmed", date: "Wed, 11th Jan" },
      { id: 2, status: "Shipped", date: "Wed, 11th Jan" },
      { id: 3, status: "Out For Delivery", date: "Wed, 11th Jan" },
      { id: 4, status: "Delivered", date: "Expected by: Mon 16th" },
    ],
    items: [
      { id: 1, name: "Product 1", color: "Space Gray", storage: "32GB", size: "1 TB", price: "$2599.00", quantity: 1 },
      { id: 2, name: "Product 2", color: "Space Gray", storage: "32GB", size: "1 TB", price: "$2599.00", quantity: 1 },
      { id: 3, name: "Product 3", color: "Space Gray", storage: "32GB", size: "1 TB", price: "$2599.00", quantity: 1 },
    ],
    payment: {
      method: "Visa",
      last4: "****",
